...
typedef enum PlayState { ADVENTURE = 0, INVENTORY, TALKING, ITEM, MINERAL_INVENTORY , LEVEL_INVENTORY, STATS_MENU, EQUIPMENT_MENU, NODE_MENU,GAME_OVER, PLANT_INVENTORY} PlayState;
